...
<?php $galltemp = (isset($_GET['gall']))?' galltemp':''; ?>
    <h1 class="page-title"> <?php global $post;	the_title(); ?> </h1>          
            ...
            <div id="portfolio" class="home-recent portfolio clearfix">
                ...
                <div class="recent-wrap two_col">
				
                	<ul id="items" class="image-grid two_col<?php echo $galltemp; ?>">
                        ...
                        ?>
                            ...
                            <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                                ...
                                <div class="post-thumb  two_col">
                                    <?php if ($galltemp==' galltemp') {
                                        ls_lightbox(get_the_ID(),469, 250);
                                    } else {
                                        ls_lightbox(get_the_ID(),440, 250);
                                    } ?>
                                </div>
