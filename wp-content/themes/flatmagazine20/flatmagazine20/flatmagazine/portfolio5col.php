...
<?php $galltemp = (isset($_GET['gall']))?' galltemp':''; ?>
    <h1 class="page-title"> <?php global $post,$thispage;	the_title(); ?> </h1>          
            ...
            <div id="portfolio" class="home-recent portfolio clearfix">
                ...
                <div class="recent-wrap five_col">
				
                	<ul id="items" class="image-grid five_col<?php echo $galltemp; ?>">
                        ...
                        ?>
                            ...
                            <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                                ...
                                <div class="post-thumb  five_col">
                                    <?php if ($galltemp==' galltemp') {
                                        ls_lightbox(get_the_ID(),187, 110);
                                    } else {
                                        ls_lightbox(get_the_ID(),164, 110);
                                    } ?>
                                </div>
