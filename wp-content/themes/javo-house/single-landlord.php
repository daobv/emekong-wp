		...
		<div class="col-md-3 fixed-sidebar">
			<div class="panel panel-default" id="single-agent-pic">
			  <div class="panel-heading">
				<h3 class="panel-title"><?php printf('%s : %s %s', __('landlord', 'javo_fr'), $author->first_name, $author->last_name);?></h3>
			  </div> <!-- panel-heading -->
			  <div class="panel-body">
				<div class="agent-pic">
					<a href="javascript:" data-toggle="modal" data-target="#landlord_contact">
				...
				<div class="panel-footer">
					...
					<a class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-target="#landlord_contact"><?php _e("Contact Us", "javo_fr"); ?></a>
				</div>
			</div>
		</div> <!-- col-md-3 -->
		<div class="col-md-9 agent-properties">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title row">
					<div class="col-md-10"><?php _e('landlord', 'javo_fr');?> : <?php echo $author->first_name." ".$author->last_name;?></div>
					<div class="col-md-2">
					<?php
			  ...
			  <div class="panel-body">
				...
				<?php #### Listing landlord Properties #### ?>
				<div class="row">
				<div class="col-md-12">
			...
			<div class="panel panel-default inner-panel">
				<div class="panel-body">
					<div class="row">
						<?php
						$javo_landlord_item_args = Array(
							"author"=> $author->ID
							, "post_status"=> "publish"
							, "posts_per_page"=> 10
							, "post_type"=> "property"
						);
						$javo_landlord_item_posts = query_posts($javo_landlord_item_args);
						wp_reset_query();
						foreach($javo_landlord_item_posts as $post){
							setup_postdata($post);
...
<div class="modal fade" id="landlord_contact" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title"><?php _e("landlord Contact", "javo_fr"); ?></h4>
			</div>
